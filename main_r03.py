...
# Drop the extra duplicate rows, keeping only the first occurrence
instagram_cleaned = instagram_df.drop_duplicates(keep='first')

# Print the cleaned DataFrame for 'Instagram'
print("\nCleaned 'Instagram' DataFrame (duplicates removed):")
print(instagram_cleaned)

# Verify the count after dropping duplicates
final_count = instagram_cleaned.shape[0]
print(f"\nFinal count of 'Instagram' rows after dropping duplicates: {final_count}")
